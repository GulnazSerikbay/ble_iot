# Just starting this file 
# Adapted from https://github.com/RCayre/mirage/blob/master/mirage/scenarios/keyboard_hid_over_gatt.py

from mirage.core import scenario
from mirage.libs import io,ble,bt,utils,wireless
from mirage.libs.common import parsers

REPORT_MAP = bytes.fromhex("05010902a10185010901a10005091901290815002501") #got from att.ini

class mouse_hid_over_gatt(scenario.Scenario):
	...
	def enableAdvertising(self):
		advertisementServices = (
            ...
            ble.UUID(UUID16=0x1801).data[::-1]+ # Generic Attribute
            ble.UUID(UUID16=0x1800).data[::-1]+ # Generic access
		...
		self.emitter.setScanningParameters(data=bytes.fromhex("0b094574c4d6f75736544756f") + data) #0d094576696c4b6579626f617264
	...
	def initializeDeviceInformationService(self):
		...
		self.server.addCharacteristic(ble.UUID(name="Manufacturer Name String").data,b"EvilMouse")
